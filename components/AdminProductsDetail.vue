		...
		<v-row dense>
			<v-col cols="12" md="6">
				<v-card variant="outlined" class="pa-3 mb-10" style="border: 0.5px solid #303030; border-radius: 8px">
					<p class="mb-4" style="font-weight: 700; font-size: 20px; line-height: 28px; color: #ececec">About product</p>
					...
					<div class="d-flex flex-column ga-4" style="font-size: 16px; font-weight: 600; line-height: 22.4px">
						<p>
							...
							<span class="user-status user-status-available">Available</span>
						</p>
						<p>
						...
						<p>
							<span class="mr-2" style="color: #454545">Product id</span>
							<span style="color: #b5b5b5">#000001</span>
						</p>
						<p>
							<span class="mr-2" style="color: #454545">Product name</span>
							<span style="color: #b5b5b5">Addidas sneakers 2024</span>
						</p>
						<p>
							<span class="mr-2" style="color: #454545">Amount</span>
							<span style="color: #b5b5b5">$40</span>
						</p>
						<p>
							<span class="mr-2" style="color: #454545">Units sold</span>
							<span style="color: #b5b5b5">40</span>
						</p>
						<p>
							<span class="mr-2" style="color: #454545">Amount</span>
						...
						<p>
							<span class="mr-2" style="color: #454545">Total sales</span>
							<span style="color: #b5b5b5">$1600</span>
						</p>
						<p class="d-flex align-center">
							...
							<span class="d-flex align-center">
								...
								<span style="color: #007e70; font-size: 18px; font-weight: 500">Belinda Bikes</span>
							</span>
						</p>
						<p>
							<span class="mr-2" style="color: rgba(69, 69, 69, 1); font-weight: 600">Date added</span>
							<span style="color: rgba(181, 181, 181, 1); font-weight: 600">August 02, 2024 <span class="dot">.</span> 08:15 AM</span>
						</p>
						<p>
							<span class="mr-2" style="color: rgba(69, 69, 69, 1); font-weight: 600">Last updated</span>
							<span style="color: rgba(181, 181, 181, 1); font-weight: 600">August 02, 2024 <span class="dot">.</span> 08:15 AM</span>
						</p>
					</div>
					<v-btn
						@click="confirmSuspend = true"
						class="btn my-4"
						size="x-large"
						rounded
						style="background: linear-gradient(180deg, #f97066 2.68%, #b42318 84.82%)"
						>Suspend</v-btn
					>
				</v-card>
			...
			<v-col cols="12" md="6">
				<v-card variant="outlined" class="pa-3" style="border: 0.5px solid #303030; border-radius: 8px">
					<div class="mb-4 d-flex justify-space-between">
						<p style="font-weight: 700; font-size: 20px; line-height: 28px; color: #ececec">Product history</p>
						<p>
